...
export default class Parent extends Component {
  render() {
    return (
      <div><section className="h-100 h-custom" style={{"background-color":"#eee"}}>
                    ...
                    <div className="card mb-3 mb-lg-0">
                      <div className="card-body">
                        <div className="d-flex justify-content-between">
                          <div className="d-flex flex-row align-items-center">
                            <div>
                              <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-shopping-carts/img4.webp" className="img-fluid rounded-3" alt="Shopping item" style={{"width":"65px"}} />
                            </div>
                            <div className="ms-3">
                              <h5>MacBook Pro</h5>
